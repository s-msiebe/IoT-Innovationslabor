...
class SensorBoardDevice
{
    ...
    public:
		...
		/*!
         * Liefert den Speicher, auf dem die Daten permanent gespeichert werden können.
         *
         * @return storage
         */
        StorageDevice &getStorageDevice();
		/*!
         * Setzt den Speicher, auf dem die Daten permanent gespeichert werden können.
		 *
		 * @param[in] storage der gesetzt wird.
         */
